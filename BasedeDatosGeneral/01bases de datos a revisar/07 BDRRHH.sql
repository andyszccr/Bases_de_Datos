USE [DBRRHH]
GO
/****** Object:  Table [dbo].[Canton]    Script Date: 17/06/2025 19:27:53 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Departamentos]    Script Date: 17/06/2025 19:27:53 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Distrito]    Script Date: 17/06/2025 19:27:53 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[HorasExtra]    Script Date: 17/06/2025 19:27:53 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ImpuestoRenta]    Script Date: 17/06/2025 19:27:53 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Liquidaciones]    Script Date: 17/06/2025 19:27:53 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[logs]    Script Date: 17/06/2025 19:27:53 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Marcas]    Script Date: 17/06/2025 19:27:53 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Permisos]    Script Date: 17/06/2025 19:27:53 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Planilla]    Script Date: 17/06/2025 19:27:53 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[provincia]    Script Date: 17/06/2025 19:27:53 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Roles]    Script Date: 17/06/2025 19:27:53 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TipoDeducciones]    Script Date: 17/06/2025 19:27:53 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TipoJornada]    Script Date: 17/06/2025 19:27:53 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TipoLiquidaciones]    Script Date: 17/06/2025 19:27:53 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TipoPermisos]    Script Date: 17/06/2025 19:27:53 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Usuarios]    Script Date: 17/06/2025 19:27:53 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Vacaciones]    Script Date: 17/06/2025 19:27:53 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[Departamentos] ([DepartamentoID], [Departamento], [DepartamentoCreate], [DepartamentoUpdate], [DepartamentoDelete], [DepartamentoStatus]) VALUES (1, N'Ventas', CAST(N'2025-03-19T07:47:13.387' AS DateTime), NULL, CAST(N'2025-03-28T22:39:33.040' AS DateTime), 0)
GO
INSERT [dbo].[Departamentos] ([DepartamentoID], [Departamento], [DepartamentoCreate], [DepartamentoUpdate], [DepartamentoDelete], [DepartamentoStatus]) VALUES (2, N'Marketing', CAST(N'2025-03-19T07:47:13.387' AS DateTime), NULL, NULL, 1)
GO
INSERT [dbo].[Departamentos] ([DepartamentoID], [Departamento], [DepartamentoCreate], [DepartamentoUpdate], [DepartamentoDelete], [DepartamentoStatus]) VALUES (3, N'Recursos Humanos', CAST(N'2025-03-19T07:47:13.387' AS DateTime), CAST(N'2025-03-19T07:47:13.387' AS DateTime), NULL, 1)
GO
INSERT [dbo].[Departamentos] ([DepartamentoID], [Departamento], [DepartamentoCreate], [DepartamentoUpdate], [DepartamentoDelete], [DepartamentoStatus]) VALUES (4, N'Tecnología', CAST(N'2025-03-19T07:47:13.387' AS DateTime), NULL, NULL, 1)
GO
INSERT [dbo].[Departamentos] ([DepartamentoID], [Departamento], [DepartamentoCreate], [DepartamentoUpdate], [DepartamentoDelete], [DepartamentoStatus]) VALUES (5, N'Finanzas', CAST(N'2025-03-19T07:47:13.387' AS DateTime), CAST(N'2025-03-19T07:47:13.387' AS DateTime), NULL, 1)
GO
INSERT [dbo].[Departamentos] ([DepartamentoID], [Departamento], [DepartamentoCreate], [DepartamentoUpdate], [DepartamentoDelete], [DepartamentoStatus]) VALUES (6, N'Soporte Técnico', CAST(N'2025-03-19T07:47:13.387' AS DateTime), NULL, NULL, 1)
GO
INSERT [dbo].[Departamentos] ([DepartamentoID], [Departamento], [DepartamentoCreate], [DepartamentoUpdate], [DepartamentoDelete], [DepartamentoStatus]) VALUES (7, N'Logística', CAST(N'2025-03-19T07:47:13.387' AS DateTime), CAST(N'2025-03-19T07:47:13.387' AS DateTime), NULL, 1)
GO
INSERT [dbo].[Departamentos] ([DepartamentoID], [Departamento], [DepartamentoCreate], [DepartamentoUpdate], [DepartamentoDelete], [DepartamentoStatus]) VALUES (8, N'Calidad', CAST(N'2025-03-19T07:47:13.387' AS DateTime), NULL, NULL, 1)
GO
INSERT [dbo].[Departamentos] ([DepartamentoID], [Departamento], [DepartamentoCreate], [DepartamentoUpdate], [DepartamentoDelete], [DepartamentoStatus]) VALUES (9, N'Investigación y Desarrollo', CAST(N'2025-03-19T07:47:13.387' AS DateTime), CAST(N'2025-03-19T07:47:13.387' AS DateTime), NULL, 1)
GO
INSERT [dbo].[Departamentos] ([DepartamentoID], [Departamento], [DepartamentoCreate], [DepartamentoUpdate], [DepartamentoDelete], [DepartamentoStatus]) VALUES (10, N'Legal', CAST(N'2025-03-19T07:47:13.390' AS DateTime), NULL, NULL, 0)
GO
INSERT [dbo].[Departamentos] ([DepartamentoID], [Departamento], [DepartamentoCreate], [DepartamentoUpdate], [DepartamentoDelete], [DepartamentoStatus]) VALUES (1002, N'Test', CAST(N'2025-03-28T22:39:42.520' AS DateTime), NULL, NULL, 1)
GO
INSERT [dbo].[Departamentos] ([DepartamentoID], [Departamento], [DepartamentoCreate], [DepartamentoUpdate], [DepartamentoDelete], [DepartamentoStatus]) VALUES (1003, N'test2', CAST(N'2025-03-28T22:39:49.743' AS DateTime), NULL, NULL, 1)
GO
...
GO
INSERT [dbo].[Liquidaciones] ([LiquidacionID], [UsuarioID], [TipoLiquidacionId], [FechaLiquidacion], [SalarioBase], [VacacionesNoDisfrutadas], [AguinaldoProporcional], [Preaviso], [Indemnizacion], [TotalLiquidacion], [Estado], [FechaPago], [Banco], [NumeroCuenta]) VALUES (1, 1, 2, CAST(N'2025-02-18' AS Date), 20000, CAST(22.00 AS Decimal(18, 2)), CAST(20000.00 AS Decimal(18, 2)), CAST(20000.00 AS Decimal(18, 2)), CAST(200000.00 AS Decimal(18, 2)), CAST(20000.00 AS Decimal(18, 2)), N'Activo', CAST(N'2025-03-19T00:00:00.000' AS DateTime), N'Banco de costarica', N'12321323123123123123')
GO
SET IDENTITY_INSERT [dbo].[Liquidaciones] OFF
GO
SET IDENTITY_INSERT [dbo].[Permisos] ON 
GO
INSERT [dbo].[Permisos] ([PermisoId], [UsuarioID], [TipoPermisoId], [PermisoStatus], [HorasSolicitadas], [PermisoCreacion], [PermisoUpdate], [PermisoDelete], [UsuarioIDAprobadoPor], [Motivo]) VALUES (1, 1, 1, 1, 4, CAST(N'2025-03-12T07:58:00.000' AS DateTime), CAST(N'2025-03-13T07:58:00.000' AS DateTime), CAST(N'2025-03-14T07:58:00.000' AS DateTime), 1, N'XD')
GO
INSERT [dbo].[Permisos] ([PermisoId], [UsuarioID], [TipoPermisoId], [PermisoStatus], [HorasSolicitadas], [PermisoCreacion], [PermisoUpdate], [PermisoDelete], [UsuarioIDAprobadoPor], [Motivo]) VALUES (2, 1, 1, 2, 1, CAST(N'2025-03-28T23:03:00.667' AS DateTime), NULL, NULL, NULL, N'maternidad')
GO
...
GO
INSERT [dbo].[Roles] ([RolID], [NombreRol], [RolCreate], [RolUpdate], [RolDelete], [RolStatus]) VALUES (1, N'Administrador', CAST(N'2025-03-19T07:35:45.983' AS DateTime), NULL, NULL, 1)
GO
INSERT [dbo].[Roles] ([RolID], [NombreRol], [RolCreate], [RolUpdate], [RolDelete], [RolStatus]) VALUES (2, N'Usuario', CAST(N'2025-03-19T07:35:45.987' AS DateTime), NULL, NULL, 1)
GO
INSERT [dbo].[Roles] ([RolID], [NombreRol], [RolCreate], [RolUpdate], [RolDelete], [RolStatus]) VALUES (3, N'Editor', CAST(N'2025-03-19T07:35:45.987' AS DateTime), CAST(N'2025-03-19T07:35:45.987' AS DateTime), NULL, 1)
GO
INSERT [dbo].[Roles] ([RolID], [NombreRol], [RolCreate], [RolUpdate], [RolDelete], [RolStatus]) VALUES (4, N'Invitado', CAST(N'2025-03-19T07:35:45.987' AS DateTime), NULL, NULL, 0)
GO
INSERT [dbo].[Roles] ([RolID], [NombreRol], [RolCreate], [RolUpdate], [RolDelete], [RolStatus]) VALUES (5, N'Moderador', CAST(N'2025-03-19T07:35:45.987' AS DateTime), CAST(N'2025-03-19T07:35:45.987' AS DateTime), NULL, 1)
GO
INSERT [dbo].[Roles] ([RolID], [NombreRol], [RolCreate], [RolUpdate], [RolDelete], [RolStatus]) VALUES (6, N'Supervisor', CAST(N'2025-03-19T07:35:45.987' AS DateTime), NULL, NULL, 1)
GO
INSERT [dbo].[Roles] ([RolID], [NombreRol], [RolCreate], [RolUpdate], [RolDelete], [RolStatus]) VALUES (7, N'Analista', CAST(N'2025-03-19T07:35:45.990' AS DateTime), CAST(N'2025-03-19T07:35:45.990' AS DateTime), NULL, 1)
GO
INSERT [dbo].[Roles] ([RolID], [NombreRol], [RolCreate], [RolUpdate], [RolDelete], [RolStatus]) VALUES (8, N'Desarrollador', CAST(N'2025-03-19T07:35:45.990' AS DateTime), NULL, NULL, 1)
GO
INSERT [dbo].[Roles] ([RolID], [NombreRol], [RolCreate], [RolUpdate], [RolDelete], [RolStatus]) VALUES (9, N'Tester', CAST(N'2025-03-19T07:35:45.990' AS DateTime), CAST(N'2025-03-19T07:35:45.990' AS DateTime), NULL, 1)
GO
INSERT [dbo].[Roles] ([RolID], [NombreRol], [RolCreate], [RolUpdate], [RolDelete], [RolStatus]) VALUES (10, N'Consultor', CAST(N'2025-03-19T07:35:45.990' AS DateTime), NULL, NULL, 0)
GO
...
GO
SET IDENTITY_INSERT [dbo].[TipoLiquidaciones] ON 
GO
INSERT [dbo].[TipoLiquidaciones] ([TipoLiquidacionId], [NombreTipo]) VALUES (1, N'Liquidación por Salario Ordinario')
GO
INSERT [dbo].[TipoLiquidaciones] ([TipoLiquidacionId], [NombreTipo]) VALUES (2, N'Liquidación por Vacaciones')
GO
INSERT [dbo].[TipoLiquidaciones] ([TipoLiquidacionId], [NombreTipo]) VALUES (3, N'Liquidación por Aguinaldo')
GO
INSERT [dbo].[TipoLiquidaciones] ([TipoLiquidacionId], [NombreTipo]) VALUES (4, N'Liquidación por Preaviso')
GO
INSERT [dbo].[TipoLiquidaciones] ([TipoLiquidacionId], [NombreTipo]) VALUES (5, N'Liquidación por Cesantía')
GO
INSERT [dbo].[TipoLiquidaciones] ([TipoLiquidacionId], [NombreTipo]) VALUES (6, N'Liquidación por Horas Extraordinarias')
GO
INSERT [dbo].[TipoLiquidaciones] ([TipoLiquidacionId], [NombreTipo]) VALUES (7, N'Liquidación por Días Feriados')
GO
INSERT [dbo].[TipoLiquidaciones] ([TipoLiquidacionId], [NombreTipo]) VALUES (8, N'Liquidación por Salario Caído')
GO
INSERT [dbo].[TipoLiquidaciones] ([TipoLiquidacionId], [NombreTipo]) VALUES (9, N'Liquidación por Auxilio de Cesantía')
GO
INSERT [dbo].[TipoLiquidaciones] ([TipoLiquidacionId], [NombreTipo]) VALUES (10, N'Liquidación por Otros Beneficios')
GO
SET IDENTITY_INSERT [dbo].[TipoLiquidaciones] OFF
GO
...
GO
INSERT [dbo].[Usuarios] ([UsuarioID], [Cedula], [Nombre], [Apellidos], [RolID], [DepartamentoID], [FechaNacimiento], [SalarioBase], [NombreUsuario], [Contrasena], [Token], [DireccionExacta], [provinciaID], [CantonID], [DistritoID], [UsuarioCreacion], [UsuarioUpdate], [UsuarioDelete], [UsuarioStatus]) VALUES (1, 1234567, N'Jefferson', N'Chavarria Montero', 1, 3, CAST(N'2000-12-22T00:00:00.000' AS DateTime), 20000, N'Admin', N'123456e', N'valor_predeterminado', N'Por ahí', 1, 9, 64, CAST(N'2025-03-19T07:48:56.320' AS DateTime), NULL, NULL, 1)
GO
INSERT [dbo].[Usuarios] ([UsuarioID], [Cedula], [Nombre], [Apellidos], [RolID], [DepartamentoID], [FechaNacimiento], [SalarioBase], [NombreUsuario], [Contrasena], [Token], [DireccionExacta], [provinciaID], [CantonID], [DistritoID], [UsuarioCreacion], [UsuarioUpdate], [UsuarioDelete], [UsuarioStatus]) VALUES (2, 1234568, N'Sebastian', N'Arrieta Urgueda', 2, 6, CAST(N'1999-03-22T00:00:00.000' AS DateTime), 20000, N'Usuario1', N'123456e', N'valor_predeterminado', N'iDAw', 5, 58, 355, CAST(N'2025-03-19T08:50:42.753' AS DateTime), NULL, NULL, 1)
GO
INSERT [dbo].[Usuarios] ([UsuarioID], [Cedula], [Nombre], [Apellidos], [RolID], [DepartamentoID], [FechaNacimiento], [SalarioBase], [NombreUsuario], [Contrasena], [Token], [DireccionExacta], [provinciaID], [CantonID], [DistritoID], [UsuarioCreacion], [UsuarioUpdate], [UsuarioDelete], [UsuarioStatus]) VALUES (1002, 1234567, N'Andrey', N'Sanchez Z', 1, 1, CAST(N'2025-03-30T00:00:00.000' AS DateTime), 20000, N'Admin', N'1234567', N'valor_predeterminado', N'Sarchi', 2, 32, 215, CAST(N'2025-03-25T22:24:39.930' AS DateTime), NULL, NULL, 1)
GO
...
GO
/****** Object:  StoredProcedure [dbo].[sp_GenerarClaseCSharp]    Script Date: 17/06/2025 19:27:54 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
--exec sp_GenerarClaseCSharp 'Roles'
